...
export default function Spot({ spot, found, isClue, onClick, delay = 0 }) {
  const CW = 1200
  const CH = 675
    ...
    >
      ...
      <div
        className={`
         ...
         ${found && isClue ? 'border-crimson/50 w-9 h-9'
            : found ? 'border-white/20 w-9 h-9'
      ...
      >
        ...
        <div
          className={`
            ...
            group-hover:scale-125
           ${found && isClue ? 'bg-crimson shadow-[0_0_8px_rgba(139,32,32,0.7)]'
              : found ? 'bg-white/25 shadow-none'
